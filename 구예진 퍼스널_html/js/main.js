...
//               .stop(true)
//               .animate({
//                 height: $(this).next().find('li.on').find('ul').height() + 24,
//               });
//           }
//         }
//       });
...
//         $(this)
//           .parent('.m_snb')
//           .animate({ height: $(this).find('ul').height() + 24 });
//       });
//     });

//     $('#header')
//       .find('.btn_top_login > a')
//       .click(function () {
//         commonTop.topLoginOpen(0);
//       });
//     $('#header')
//       .find('.top_login_tab > li > a')
//       .click(function () {
...
//     var _y =
//       $('#header').find('.header_wrap h1').innerHeight() +
//       $('#wrap').offset().top;
//     if (SW > 750 && npos >= _y) {
...
//     $('#header')
//       .find('.top_login .top_login_tab_con > div')
//       .eq(_i)
//       .addClass('actived')
//       .siblings()
//       .removeClass('actived');
//     $('#header')
//       .find('.top_login .top_login_tab > li')
//       .eq(_i)
//       .addClass('actived')
//       .siblings()
//       .removeClass('actived');
